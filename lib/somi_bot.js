...
var SOMI_CURRENCIES = ['gem', 'beetle', 'drupal'];
...
var SOMI_CURRENCIES_TRANSLATIONS = {
  ...
  drupal: {
    // Падежи и склонения.
    nominative: {1: 'Друпликон', 2: 'Друпликона', 3: 'Друпликонов'},
    prepositional: {1: 'Друпликоне', 2: 'Друпликонах', 3: 'Друпликонах'},
    accusative: {1: 'Друпликон', 2: 'Друпликона', 3: 'Друпликонов'},
    instrumental: {1: 'Друпликоном', 2: 'Друпликонами', 3: 'Друпликонами'},

    error_status: {msg: '*Друпликация на %qty% %goods% не удалась!* :no_entry_sign:\n\n*Отправитель*', case: 'accusative'},

    op_header: 'Друпликация за контрибьют',

    event_error: '_Произошла ошибка при друпликации_',
    event_remind: '_Напоминание_',
    event_private: {msg: '_Вас наградил(а) %qty% %goods% %usr%_', case: 'instrumental'},
    event_owner: {msg: '_Вы наградили %qty% %goods% %users%_', case: 'instrumental'},
    event_channel: {alt: '_Был(а) награжден(а) %users%_', msg: '_Были нарграждены %users%_', case: 'nominative'},

    op_status: {msg: '*Друпликация на %qty% %goods% прошла успешно!* :white_check_mark:\n\n*От кого*', case: 'nominative'},
    op_status_private: {msg: '*Вас наградили %qty% %goods%!* %currencies%\n\n*От кого*', case: 'instrumental'},
    op_status_remind: {msg: ':bell: *Вы хотели наградить %qty% %currency%*', case: 'instrumental'},

    attach_balance_remind_title: 'Друпликонов на вашем счете',
    attach_balance_private_title: 'Друпликонов у вас в наличии',
    attach_balance_owner_title: 'Друпликонов осталось',
    attach_balance_needed_title: 'Не хватает друпликонов',
    op_color : 'good',
    op_remind: 'Подарить'
  },
  beetle: {
